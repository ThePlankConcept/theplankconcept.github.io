...
const LoginScreen = () => {
  ...
  return (
    ...
    <Form.Group controlId="email">
       ...
       <Form.Control className="rounded-pill pt-2 pb-2   mb-3 control-styling" type="email" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)}></Form.Control>
      </Form.Group>
     <Form.Group controlId="password">
  
       <Form.Control className="rounded-pill  mb-3 pt-2 pb-2 control-styling"  type="password" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)}></Form.Control>
      </Form.Group>
    ...
    <p>No Account Yet ?</p>
      ...
      <Row>
        <Col className="d-flex justify-content-center">
   <Button onClick={routeChange} className="rounded-pill login-btn pt-1 pb-1 " >CREATE ACCOUNT </Button>
        </Col>
      </Row>
     </Container>
      </Col>
