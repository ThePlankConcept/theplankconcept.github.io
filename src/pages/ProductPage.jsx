...
const ProductPage2 = () => {
  ...
  const { loading: wishlistLoading, userWishList } = getUserWishList;
  ...
  useEffect(() => {
    ...
    console.log("userwoo", userWishList);
    setSelected(1);
    if (loading === false) {
    ...
    window.scrollTo(0, 0);
  }, [dispatch, slug, loading, inventory, userInfo, wishlist, updateWishlistLoading]); //here was also inventory
  ...
  const addProductToWishlisthandler = (wish_list) => {
    console.log("called action to add item to wishlist", wish_list, selectedProduct, product[0].id);
    dispatch(updateuserwishlist({ product: product[0].id, wishlistid: wish_list }));
    setToggler(true);
  };
  const removeProductFromWishlist = (wish_list) => {
    dispatch(removeItemFromWishlist({ product: product[0].id, wishlistId: wish_list.id }));
  };
  ...
  const CustomPopovers = React.forwardRef((props, ref) => (
    <Popover id="popover-basic" innerRef={ref} {...props} style={{ left: "20%", minWidth: "60%" }}>
      ...
      <Popover.Body className="px-4">
        {wishlistLoading || updateWishlistLoading ? (
          <Loader />
        ) : (
          <Container>
            <Container
                ...
                userWishList.data.map((list) => {
                  return (
                    <Row key={list.id} className="py-1">
                      <Col>
                        {list.attributes.products.data.some((prod) => prod.id === product[0].id) ? (
                          <Button
  ...
  const checkItemInWishlist = () => {
    if (userWishList) {
      const prod = userWishList.data.map((wish) => {
        return wish.attributes.products.data.some((p) => p.id === product[0].id);
      });
                        ...
                        {userInfo ? (
                          <>
                            <FontAwesomeIcon
                              ...
                              onClick={() => heartIconListener(product[0].id)}
                            />
                            <Overlay
            ...
            <Col>
              <Container>
                <Row>
                  ...
                  >
                    <span
                      className={contentState ? "item-details-title " : "item-details-title-2 "}
                    >
                      Item Details
                    </span>
                  </Col>
                ...
                <Row>
                  <Col className={contentState ? "lower-border" : "lower-border-2"}></Col>
                </Row>
              </Container>
            </Col>
            <Col>
                        ...
                        <Row>
                          ...
                          <Col>
                            <p className="item-details-text">
                              There’s nothing better than having a sectional that serves a
                              dual-purpose! The Sophie Sectional Bed has you covered with its
                              comfortable sofa by day and bed by night.{" "}
                            </p>
                          </Col>
                        </Row>
                        <Row>
              ...
              <Row>
                <Col className="text-center">
                  <Container className="px-5">
                    <Row className="py-3">
                      <Col className="contentheading">It’s effortless.</Col>
                    </Row>
                    <Row>
                      <Col className="contentpara">
                        You don't have to lift a finger. Delivery and assembly are both included. If
                        you're renting, we'll pick up your stuff for free too, or transport it to
                        your new home if you move.
                      </Col>
                    </Row>
                    ...
                    <Row className="py-3">
                      <Col className="contentheading">We’re flexible.</Col>
                    </Row>
                    <Row>
                      <Col className="contentpara">
                        Creating your home should be easy. That’s why we offer flexible options to
                        rent, buy, or rent-to-own. Rent, and avoid high upfront costs in favor of
                        small monthly payments. Buy, and your furniture is yours to keep!
                      </Col>
                    </Row>
                    <Row className="d-flex justify-content-center  py-1">
                      <Col md={1}>
                    ...
                    <Row className="py-3">
                      <Col className="contentheading">Your home will look beautiful.</Col>
                    </Row>
                    <Row>
                      <Col className="contentpara">
                        We've thoughtfully curated a select offering of beautiful, high-quality
                        furniture pieces that will go perfectly with your home. Add extra personal
                        touches with our selection of décor, lighting, and plants to match your
                        furniture.
                      </Col>
                    </Row>
                  </Container>
                ...
                <Col>
                  <Row>
                    <Col md={10} style={{ backgroundColor: "rgba(194, 207, 222, 0.3)" }}>
                      <Row>
                        <Col className="contentheading p-4" style={{ color: "#333333" }}>
                      ...
                      <Container className="px-4 pb-5">
                        <Row className="align-items-center py-3">
                          ...
                          <Col md={10}>
                            <Row>
                              <Col className="contentHeading2"> Our furniture is made to last.</Col>
                            </Row>
                            <Row>
                              <Col className="contentPara2">
                                Our furniture is made to last. We only source items from trusted,
                                credible manufacturers. These items are high quality and guaranteed
                        ...
                        <Row className="align-items-center py-3">
                          ...
                          <Col md={10}>
                            <Row>
                              <Col className="contentHeading2">
                                We’re working to reduce furniture waste.
                              </Col>
                            </Row>
                            <Row>
                              <Col className="contentPara2">
                                Together we can cut down on the 9.8 million tons of "fast furniture"
                                that ends up in a landfill each year.
                              </Col>
                            </Row>
                          </Col>
                        </Row>
                        <Row className="align-items-center py-3">
                          ...
                          <Col md={10}>
                            <Row>
                              <Col className="contentHeading2">We keep it fresh.</Col>
                            </Row>
                            <Row>
                              <Col className="contentPara2">
                                All furniture goes though an 11-step sanitation and refurbishment
                                process using sustainably sourced materials.
                              </Col>
                            </Row>
                          </Col>
                        </Row>
