...
import { Container, Row, Col, Form, Button, OverlayTrigger, Modal, Popover } from "react-bootstrap";
...
import { faCircle, faArrowRight, faPlus } from "@fortawesome/free-solid-svg-icons";
...
const ProductPage2 = () => {
  ...
  useEffect(() => {
    ...
    window.scrollTo(0, 0);
  }, [dispatch, slug, loading, inventory, userInfo, wishlist]); //here was also inventory
  ...
  const addProductToWishlisthandler = (wish_list) => {
    console.log("aw", { product: wishlistProduct, wishlistid: wish_list });
  ...
  const UPopover = React.forwardRef(({ props }, ref) => {
    return (
                    ...
                    <Row key={list.id} className="py-1">
                      <Col>
                        <Button
                          ...
                          style={{ minWidth: "fit-content", textTransform: "none" }}
                          onClick={() => {
      ...
      <Container className="mt-5    ">
        <Row>
          ...
          <Col lg="6">
            <Container fluid>
              <Row>
                <Col className="firstimageContainer" ref={ref}>
                  {/* "https://plank-strapi.herokuapp.com"+ */}
                  {productDetails && loading == false ? (
                    <>
                      <img
                      ...
                      {userInfo ? (
                        <OverlayTrigger
                          ...
                          placement="left"
                          container={ref}
                          overlay={<UPopover id="popover-contained" />}
                        >
                          <FontAwesomeIcon
...
// import { useDispatch, useSelector } from "react-redux";
// import { listProductDetails, relatedItems } from "../actions/productActions";
// import { addToCart, addToCart2 } from "../actions/cartActions";
...
// import "react-multi-carousel/lib/styles.css";
// import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
// import { faArrowRight, faPlus, faCircle } from "@fortawesome/free-solid-svg-icons";
// import "./ProductPage.css";
// import Header from "../components/Header";
// const ProductPage2 = () => {
//   const { slug } = useParams();
...
//     window.scrollTo(0, 0);
//   }, [dispatch, slug, loading, inventory]);

//   const addToCartHandler = (quantity, subscription) => {
...
//   const formSubmit = (e) => {
//     e.preventDefault();
//     addToCartHandler(quantity, true);
...
//                     <Row>
//                       <Col>
//                         <p style={{ fontFamily: "Roboto", fontWeight: "600" }}>Choose Color</p>
//                       </Col>
//                     </Row>
//                     <Row className="pb-4">
//                       {productDetails.product[0].attributes.product_inventories.data.map(
...
//                               <span className="buyNowText">
//                                 {" "}
//                                 Buy for {productDetails.product[0].attributes.price *
//                                   buyQuantity}{" "}
//                                 AED
//                               </span>
//                             </Col>
