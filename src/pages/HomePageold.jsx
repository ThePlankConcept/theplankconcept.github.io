              ...
              <Col className="lastrowfirstcol" lg={6}>
                <Row>
                  <Col>
                    ...
                    <p className="brief ">We move a lot. There are countless floor plans and roommates (oh, and your evolving tastes) between here and there. With Plank, furnish your space without breaking a sweat or reaching for a screwdriver.</p>
